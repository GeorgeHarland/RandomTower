...
export const POISON_CLOUDS_BASE_AMOUNT = 3;
...
export const POISON_CLOUDS_DAMAGE_FREQUENCY = 100;
export const POISON_CLOUDS_LEVELUP_SCALE = 0.05;
...
export const TORNADO_BASE_SHAKE_AMOUNT = 5;
